...
const CheckoutPage = () => {
      ...
      // const currentUser = true; // Manual process of getting the current user
     const { currentUser } = useAuth();    // technical/auto process
       const {
           register,
           handleSubmit,
           watch,
         ...
         const [isChecked, setIsChecked] = useState(false) // Fixed typo: setIsCheked -> setIsChecked
         const onSubmit = async (data) => {
            //  console.log(data)
             const newOrder = {
                name: data.name, // Changed from data.name to data.full_name to match register name
                email: currentUser?.email, // Fixed: removed data. prefix since email is disabled and uses currentUser
                address: {
                    city: data.city,
  ...
  icon: "success", // Changed from "warning" to "success" for better UX
                        ...
                        <div className="lg:col-span-2">
                            <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                <div className="md:col-span-5">
                                    ...
                                    <input
                                          {...register("name", { required: true })} // Changed register name to match
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <div className="h-10 bg-gray-50 flex border border-gray-200 rounded items-center mt-1">
                                        ...
                                        <button type="button" tabIndex="-1" className="cursor-pointer outline-none focus:outline-none border-l border-gray-200 transition-all text-gray-300 hover:text-blue-600">
                                ...
                                <div className="md:col-span-5 mt-3">
                                    <div className="inline-flex items-center">
                                        ...
                                        checked={isChecked}
                                        onChange={(e) => setIsChecked(e.target.checked)} // Added onChange handler
                                        />
                                        <label htmlFor="billing_same" 
                                        className="ml-2 ">I agreed to the 
                                        <Link className='underline underline-offset-2
                                         text-blue-600'> Terms & Conditions
                                         </Link> and <Link className='underline underline-offset-2
                                          text-blue-600'> Shopping Policy.</Link></label>
                                    </div>
                                </div>
                                ...
                                <div className="md:col-span-5 text-right">
                                    <div className="inline-flex items-end">
                                        <button 
                                        type="submit" // Added type="submit" to make it clear this is a submit button
                                        disabled={!isChecked}
...
//                                         />
//                                         <label htmlFor="billing_same" 
//                                         className="ml-2 ">I aggreed to the 
//                                         <Link className='underline underline-offset-2
//                                          text-blue-600'>Terms & Conditions 
//                                          </Link> and <Link className='underline underline-offset-2
//                                           text-blue-600'>Shoping Policy.</Link></label>
//                                     </div>
//                                 </div>

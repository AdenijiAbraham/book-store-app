// Updated booksApi.js - Fixed to use dynamic base URL
import { createApi, fetchBaseQuery } from '@reduxjs/toolkit/query/react';
import getBaseUrl from '../../../utils/baseURJ.js';
// import getBaseUrl from '../../../utils/baseURJ.js'; // Import your getBaseUrl function
...
const booksApi = createApi({
  ...
  baseQuery: fetchBaseQuery({
    baseUrl: getApiBaseUrl(), // ← Now uses dynamic URL instead of hardcoded localhost
...
// ✅ FIXED: Helper function to get full image URL using dynamic base URL
export const getImageUrl = (imageName) => {
  ...
  const baseUrl = getBaseUrl();
  const imageUrl = `${getBaseUrl}/uploads/${imageName}`;
